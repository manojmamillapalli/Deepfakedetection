...
def run(video_path, video_path2):
    ...
    threshold_frames_for_deepfake = 10
    ...
    while cap.isOpened():
        ...
        if frame_count % frames_between_processing == 0:
            # Face detection and similarity check
    ...
    if frame_count > 0:
        ...
        accuracy = 0  # Handle case where no frames were processed

    return int(accuracy), video_path2
